...
def ConfirmationAccountMail(request,emailto,usrname,passwrd):
    ...
    send_mail("Welcome To Virtual Wallet!",content, "virtual_wallet@hotmail.com", [emailto])
